		...
		<div class="container">
			...
			<!-- start: Row -->
      		<div class="row-fluid">
        		...
        		<div class="span12">
					...
					<p class="text-center">
						We are suppliers of industrial and household cleaning materials
					</p>	
			...
			<!-- end: Row -->	
      		...
      		<div class="row-fluid">
        		...
        		<div class="span4">
          			<div class="icons-box">
						<i class="fa fa-icon-beaker fa-3x"></i>
						    <h3>Home and Office</h3>
                            <p>Dish Wash products, Disinfectants, Laundry products, Toilet Bowl cleaners.</p>
        		...
        		<div class="span4">
          			<div class="icons-box">
						<i class="fa fa-industry fa-3x"></i>
						    <h3>Industy and Factory</h3>
                            <p>Industrial Cleaning materials</p>
						<div class="clearfix"></div>
					</div>
        		</div>
        		...
        		<div class="span4">
          			<div class="icons-box">
						<i class="fa fa-automobile fa-3x"></i>
						    <h3>Automobiles</h3>
                            <p> Automobile Cleaning products. </p>
						<div class="clearfix"></div>
					</div>
        		</div>
					...
					<div class="span12">
						<div class="pricing-table">
							<div class="color-cccddd">
								...
								<h4><span class="price">Featured Products</span></h4>
								<ul>
								    <li><h3>Home and Office</h3></li>
									<li>Bleach</li>
									<li>Dishwashing liquid</li>
									<li>Fabric softener</li>
									<li><h3>Industry and Factory</h3></li>
                                   	<li>Sanitiser</li>
									<li>Black santiser concentrate</li>
									<li>Pine Gel</li>
									<li> <h3>Automobiles</h3></li>
                                    <li>Car shampoo</li>
									<li>Car wash and wax</li>
									<li>Tyre and dash shine</li>
								</ul>
								<a href="/documents/pricelist.pdf" class="buy"><span>Download Our Price List</span></a>
							</div>
						</div>
					</div>
                    </div>
	...
	<div id="about" class="color yellow">
		...
		<div class="container">
	    	...
	    	<div class="row-fluid">
				...
				<div class="span12">
					...
					<div id="story">
						<h3>Our Story</h3>
						<p>
						    Soaperb products (Pty) Ltd is the brainchild of Salih Mobara, a university student whose endeavour was to create a cheaper alternative to everyday soaps and detergents for use in commercial, industrial and domestic settings. After months of research and consultations with professionals in the field of chemical production, Soaperb products was born. 
					...
					<div id="history">
						<h3>History</h3>
						<p>
						Established in February 2015, we started as a home based business supplying to a limited clientele base. We have since grown from our humble beginnings and are now operating from a factory setting. We have become the preferred supplier for various companies in the catering, hospitality and retail industries. </p>
			...
			<div class="row-fluid">		
				...
				<div class="span12">
					<h3>Our mission</h3>
				    <p >Our primary mission is to build lasting relationships with clients while supplying them with high quality products at the cheapest possible price. All our products are manufactured in-house at our factory, as such, we have complete control over the quality of our products. Our aim is to become the leading supplier of soaps and detergents in the industry starting with the Western Cape and growing from there on.
	...
	<div class ="span12">
		...
		<div id="team">
			...
			<hr class="clean visible-phone">
				...
				<div class="span10">
					<div class="avatar">
						<img class="img-circle" src="img/salih.jpg" alt="team member">
					</div>	
					<div class="team-name"> Salih Mobara</div>
		...
		<div class="container">
			...
			<div class="row-fluid">		
				...
				<div class="span12">
					...
					<!-- start: Contact Info -->
					<b>Soaperb Products (Pty) Ltd</b> •
					Unit 15 Excel workshops •
					10 Laker street, Broadlands industrial, Strand ,Cape Town, ZA •
					Phone: (+27) 71 560 8103 •
					Email: soaperbproducts@gmail.com •
					<!-- end: Contact Info -->
				...
				<div class="span6">
					...
					<script type="text/javascript">
						$('#map').gMap({
							...
							markers: [
								{
								    address: '10 Laker street, Broadlands industrial, Strand ,Cape Town, ZA', // Your Adress Here
									html: '',
									popup: false,
								}
